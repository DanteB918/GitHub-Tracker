    ...
    <form class="d-flex justify-center flex-column p-4 form" wire:submit="updateOrCreate">
        ...
        <div class="form-group">
            ...
            <div style="display: flex; align-tems: center;">
                <input @if($hidden) type="password" @else type="text" @endif class="form-control w-75" placeholder="GitHub Access Token" wire:model="token" autofocus />
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" placeholder="GitHub username" wire:model="username" />
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" placeholder="GitHub Repo Name" wire:model="repository" />
